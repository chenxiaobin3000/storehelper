...
export default {
  ...
  children: [{
    ...
    name: 'storage_stock', meta: { title: '库存明细', roles: [801] }
  }, {
    path: 'getList', component: () => import('@/views/storage/getList'),
    name: 'storage_getList', meta: { title: '订单明细', roles: [802] }
  }, {
    path: 'purchase', component: () => import('@/views/storage/purchase'),
    name: 'storage_purchase', meta: { title: '入库录入', roles: [803] }
  }, {
    path: 'dispatch', component: () => import('@/views/storage/dispatch'),
    name: 'storage_dispatch', meta: { title: '出库录入', roles: [804] }
  }, {
    path: 'loss', component: () => import('@/views/storage/loss'),
    name: 'storage_loss', meta: { title: '损耗录入', roles: [805] }
  }]
}
