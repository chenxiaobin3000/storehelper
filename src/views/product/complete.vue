<template>
  <div class="app-container">
    ...
    <div class="filter-container" align="center">
      <span class="filter-item">----------  生产入库单信息  ----------</span>
    </div>
    ...
    <el-dialog title="生产入库单" :visible.sync="dialogVisible">
...
import { addOrderRemark, getProductOrder } from '@/api/order'
import { addOrderFare } from '@/api/transport'
import { complete } from '@/api/product'
