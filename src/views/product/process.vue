<template>
  <div class="app-container">
    ...
    <div class="filter-container" align="center">
      <span class="filter-item">----------  生产出库单信息  ----------</span>
    </div>
    ...
    <el-dialog title="生产出库单信息" :visible.sync="dialogVisible">
...
import { process } from '@/api/product'
...
export default {
  ...
  methods: {
    ...
    handleAdd(row) {
      ...
      row.price = (row.iprice / row.sweight * row.iweight).toFixed(2)
